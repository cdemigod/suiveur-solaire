...
var canvas, ctx;
var automaticButton = document.getElementById('toggle-automatic'); // Ajout de la référence au bouton
...
function Draw(event) {
    if (paint) {
        ...
        // Vérifie le mode automatique et affiche ou masque le bouton en conséquence
        var automaticState = document.getElementById("automatic-state").textContent.trim().toLowerCase();
        if (automaticState === 'activé') {
